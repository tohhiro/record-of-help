...
export const headerStyles = tv({
  ...
  slots: {
    ribbonText:
      'inline-block absolute py-[7px] left-[-26px] top-[10px] w-[100px] text-center text-xs leading-4 bg-green-400 opacity-90 tracking-wider rotate-[-45deg] shadow-[0 2px 5px rgba(0, 0, 0, 0.2)]',
    ...
    headerTitle:
      'self-center text-2xl font-semibold whitespace-nowrap hover:text-green-400 dark:text-white',
    hamburgerMenu:
    ...
    menuLiStyle: 'block py-2 px-3 md:p-0 md:hover:text-green-400',

export const headerStyles = {
  ...
  headerTitle:
    'text-white self-center text-2xl font-semibold whitespace-nowrap dark:text-white hover:text-blue-700',
  hamburgerMenu:
  ...
  menuLiStyle: 'block text-white py-2 px-3 md:p-0 md:hover:text-blue-700',
};
